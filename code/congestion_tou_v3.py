...
df_summary.to_csv(_TABLE_DIR + 'tou_summary_table.csv', index=False)
...
plt.tight_layout()
plt.savefig(OUT_DIR + 'fig_tou_schedule.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(OUT_DIR + 'fig_tou_hourly_vc.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(OUT_DIR + 'fig_wtp_equity.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(OUT_DIR + 'fig_tou_heatmap.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(OUT_DIR + 'fig_tou_behaviour.png', dpi=150, bbox_inches='tight')
plt.close()
...
df_burden.to_csv(_TABLE_DIR + 'tou_burden_table.csv', index=False)
