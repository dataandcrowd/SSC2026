...
# Load NetLogo original
print("  Loading NetLogo original data...")
df_orig_0 = pd.read_csv(
    '/sessions/intelligent-awesome-shannon/mnt/Congestion/csv/raw_data/'
...
df_summary.to_csv('/sessions/intelligent-awesome-shannon/summary_table.csv', index=False)
...
plt.tight_layout()
plt.savefig('/sessions/intelligent-awesome-shannon/fig1_vc_hourly.png', dpi=150, bbox_inches='tight')
plt.close()
print("\nFigure 1 saved.")
...
plt.tight_layout()
plt.savefig('/sessions/intelligent-awesome-shannon/fig2_vc_density_scatter.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('/sessions/intelligent-awesome-shannon/fig3_fee_impact.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('/sessions/intelligent-awesome-shannon/fig4_heatmap.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('/sessions/intelligent-awesome-shannon/fig5_learning.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('/sessions/intelligent-awesome-shannon/fig6_behaviour.png', dpi=150, bbox_inches='tight')
plt.close()
